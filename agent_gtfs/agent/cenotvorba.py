"""
cenotvorba.py — Modul pre výpočet ceny za spracovanie požiadaviek cez LLM.

Poskytuje funkcie pre výpočet celkovej ceny na základe modelu,
počtu použitých prompt tokenov a completion tokenov.

Ceny sú uvádzané v USD za 1 milión tokenov (1M).
"""
